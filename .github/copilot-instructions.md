...
- [UI Guidelines](../docs/ui-guidelines.md) - UI component, colour, layout, and accessibility guidelines for the TODO app
- [Testing Guidelines](../docs/testing-guidelines.md) - Testing principles, conventions, and coverage requirements for the TODO app
- [Coding Guidelines](../docs/coding-guidelines.md) - Coding style, formatting, linting, and quality principles for the TODO app
